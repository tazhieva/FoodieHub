...
class RegisterViewModel {
    ...
    func saveUserInfo() {
        ...
        let userObject = User(username: username, phoneNumber: phoneNumber, address: address, deliveryDay: pickedDay, deliveryPeriod: pickedPeriod, subscriptionPeriod: subscriptionPeriod)
        ...
        UserSettings.subscriptionPeriod = subscriptionPeriod
    }
}
